...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-iuoit2y.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-iuoit2y.containers.anotherwebservice.com/
...
```
git clone git@github.com:Asymmentric/container-iuoit2y.git
cd container-iuoit2y
```
...
```
docker attach container-iuoit2y
```
